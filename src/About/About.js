...
function About() {
  return (
  <div id='about' >
    <section id="about-meinazhu">
      <div className="row">
        <h2>MEET MEINA ZHU-CHHIMI</h2>
      </div>
      <div className="row">
        <div className="about-meinazhu-headshot"></div>
        <div className="about-meinazhu-details">Dr. Meina Zhu-Chhimi worked in New York Presbyterian Hospital, the #1 hospital in New York, where she received specialized training in spine related disorders. She has doctorate of physical therapy degree from Ithaca College, received Certified Manual Therapy and Meek's Method certification and is trained in Mckenzie method. She is a member of American Physical Therapy Association, regularly take continuing educational courses to stay current with knowledges in file of PT. She is able to combine her experience in outpatient, acute care, inpatient  rehab and home care with her passion to help people, providing the best quality care to those in need.</div>
      </div>
    </section>
    <section id="specialization-details">
      <div className="row">
        <h2>SPECIALTIES</h2>
      </div>
      <div className="sarah-meek-method">
